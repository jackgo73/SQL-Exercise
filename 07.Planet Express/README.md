...
![Computer-store-db](img/Planet-express-db.png)
...
CREATE TABLE Package (
  ...
  Sender INTEGER NOT NULL
    CONSTRAINT fk1_Client_AccountNumber REFERENCES Client(AccountNumber),
  Recipient INTEGER NOT NULL
    CONSTRAINT fk2_Client_AccountNumber REFERENCES Client(AccountNumber),
...
1 The first several exercises build on each other and illustrate the use of subqueries. Who received a 1.5kg package?
